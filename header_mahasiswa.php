...
<head>
    ...
    <style>
        :root {
            --primary-color: #10B981; /* Aksen Hijau untuk Mahasiswa */
            --primary-light: #D1FAE5;
            --sidebar-bg: #1F2937; --sidebar-text: #D1D5DB; --sidebar-hover: #374151; --sidebar-active: var(--primary-color);
            --main-bg: #F9FAFB;
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="mata_praktikum.php" class="<?php echo ($current_page == 'mata_praktikum.php') ? 'active' : ''; ?>"><i class='bx bx-search-alt'></i> Cari Praktikum</a></li>
            <li><a href="praktikum_saya.php" class="<?php echo in_array($current_page, ['praktikum_saya.php', 'detail_praktikum.php']) ? 'active' : ''; ?>"><i class='bx bx-book-bookmark'></i> Praktikum Saya</a></li>
        </ul>
